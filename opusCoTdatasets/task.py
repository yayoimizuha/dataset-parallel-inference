...
class Task(InferenceTask):
    def __init__(self):
        ...
        if dataset_path and dataset_path.endswith(".jsonl"):
            ...
            self.dataset = load_dataset("nohurry/Opus-4.6-Reasoning-3000x-filtered", "chat", split="train",
                                        streaming=False)
        load_dotenv(path.join(dirname(__file__), ".env"))
